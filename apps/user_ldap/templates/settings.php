...
<form id="ldap" class="section" action="#" method="post">
	...
	<fieldset id="ldapSettings-1">
		...
		p(' selected');
				...
				<p><label for="ldap_nested_groups"><?php p($l->t('Nested Groups'));?></label><input type="checkbox" id="ldap_nested_groups" name="ldap_nested_groups" value="1" data-default="<?php p($_['ldap_nested_groups_default']); ?>"  title="<?php p($l->t('When switched on, groups that contain groups are supported. (If your group member attribute does not contain DNs, please make sure to fill out the appropriate Group Search Attributes.)'));?>" /></p>
